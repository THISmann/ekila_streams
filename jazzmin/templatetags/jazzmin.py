...
from .. import version
from ..settings import CHANGEFORM_TEMPLATES
from ..settings import get_settings
from ..settings import get_ui_tweaks
from ..utils import get_admin_url
from ..utils import get_filter_id
from ..utils import has_fieldsets_check
from ..utils import make_menu
from ..utils import order_with_respect_to
...
def jazzmin_list_filter(cl: ChangeList, spec: ListFilter) -> SafeText:
    ...
    return tpl.render(
        {"field_name": field_key, "title": spec.title, "choices": choices, "spec": spec}
    )
